...
namespace SmartLawyer.Models.Values
{
    public static class FeesTable
    {
        ...
        public static ColumnInfo FeDeIdFk { get; } = ("fe_de_id_fk", typeof(String));
        public static ColumnInfo FeFileIdFk { get; } = ("fe_file_id_fk", typeof(int));
        public static ColumnInfo FeCurrencyTypeCfk { get; } = ("fe_currency_type_cfk", typeof(String));
        public static ColumnInfo FeNoticIdFk { get; } = ("fe_notic_id_fk", typeof(String));
    }
}